...
export const CONTRACTORYOU_EVENTS = [
  ...
  "PROJECT_VISIT_COMPLETED",
  "PROJECT_LABOR_OVER_BUDGET",
  "PROJECT_MATERIAL_REQUIRED",
  "PROJECT_MATERIAL_RECEIVED",
  "PROJECT_ISSUE_CREATED",
  "PROJECT_ISSUE_RESOLVED",
  "PROJECT_BILLING_MILESTONE_READY",
  "PROJECT_CHANGE_ORDER_APPROVED",
  "PROJECT_COMPLETED",
] as const;

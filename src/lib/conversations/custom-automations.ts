...
export const CONNECTED_TRIGGERS = new Set<string>([
  "LEAD_CREATED", "MISSED_CALL", "JOB_BOOKED", "JOB_COMPLETED",
  "APPOINTMENT_REMINDER_DUE", "TECHNICIAN_ON_MY_WAY", "MAINTENANCE_DUE",
]);
...
export const ACTION_LABELS: Record<string, string> = {
  ...
  REQUEST_HUMAN_HANDOFF: "Escalate to human and create an office review task",
};
...
export const GOAL_ACTIONS: Record<string, string[]> = {
  BOOK_MAINTENANCE: ["READ_CUSTOMER", "READ_PROPERTY", "CHECK_AVAILABILITY", "BOOK_APPOINTMENT", ...COMMON],
  CONFIRM_APPOINTMENT: ["READ_JOB", "READ_PROPERTY", "CHECK_AVAILABILITY", "RESCHEDULE_APPOINTMENT", "ADD_CUSTOMER_REQUEST_NOTE", ...COMMON],
  RECOVER_MISSED_CALL: ["READ_CUSTOMER", "READ_PROPERTY", "CHECK_AVAILABILITY", "BOOK_APPOINTMENT", ...COMMON],
  QUALIFY_NEW_LEAD: ["READ_CUSTOMER", "READ_PROPERTY", "CHECK_AVAILABILITY", "BOOK_APPOINTMENT", ...COMMON],
  FOLLOW_UP_ESTIMATE: ["READ_ESTIMATE", ...COMMON],
  COLLECT_PAYMENT: ["READ_INVOICE", ...COMMON],
  GET_REVIEW: [...COMMON],
  RENEW_MEMBERSHIP: ["READ_MEMBERSHIP", ...COMMON],
  ...
  FOLLOW_UP_COMPLETED_JOB: ["READ_JOB", ...COMMON],
  CREATE_TASK: [...COMMON],
  NOTIFY_OFFICE: [...COMMON],
};
...
export function minimumActions(goal: string) {
  const actions = GOAL_ACTIONS[goal] || ["REQUEST_HUMAN_HANDOFF"];

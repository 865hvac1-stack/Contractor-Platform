        ...
        messages: [
          {
            ...
            content: [
              ...
              "When facts.conversationGoal is present, continue that goal naturally in the same thread.",
              "Take only actions listed in facts.allowedConversationActions. A goal never grants permission by itself.",
              "Use a promotion only when it appears in facts.promotion, and repeat its exact offer and terms without inventing discounts.",

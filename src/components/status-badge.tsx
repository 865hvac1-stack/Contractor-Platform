...
const toneMap: Record<string, string> = {
  ...
  "AUTHENTICATED — NEEDS ATTENTION": "bg-amber-50 text-amber-800",
  AUTHENTICATED_NEEDS_ATTENTION: "bg-amber-50 text-amber-800",
  "CONNECTION ERROR": "bg-rose-50 text-rose-800",
  CONNECTION_ERROR: "bg-rose-50 text-rose-800",

...
export function MetricRing({
  ...
  return (
    <div className="flex min-w-[10.5rem] flex-1 items-center gap-3 rounded-2xl border border-[var(--border)] bg-white p-3 md:min-w-0">
      ...
      {configureHref ? (
        <Link href={configureHref} className="shrink-0 text-[11px] font-medium text-[var(--cy-orange)]">
          Set a target
        </Link>
      ) : null}
    </div>

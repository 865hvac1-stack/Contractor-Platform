...
-- RenameIndex
ALTER INDEX "CompensationEvent_companyId_ruleId_sourceType_sourceId_userId_k" RENAME TO "CompensationEvent_companyId_ruleId_sourceType_sourceId_user_key";

-- RenameIndex
ALTER INDEX "ConvSchedState_company_inbound_key" RENAME TO "ConversationSchedulingState_companyId_lastInboundMessageId_key";

-- RenameIndex
ALTER INDEX "ImportExternalRef_companyId_sourceSystem_recordType_externalId_" RENAME TO "ImportExternalRef_companyId_sourceSystem_recordType_externa_key";

-- RenameIndex
ALTER INDEX "ProviderIdentityMap_companyId_provider_entityType_externalId_ke" RENAME TO "ProviderIdentityMap_companyId_provider_entityType_externalI_key";

-- RenameIndex
ALTER INDEX "ProviderIdentityMap_companyId_provider_entityType_internalId_ke" RENAME TO "ProviderIdentityMap_companyId_provider_entityType_internalI_key";

-- RenameIndex
ALTER INDEX "ProviderTestGrant_ownerCompanyId_providerKey_ownerLocationId_id" RENAME TO "ProviderTestGrant_ownerCompanyId_providerKey_ownerLocationI_idx";

-- RenameIndex
ALTER INDEX "QuickBooksImportReview_companyId_environment_realmId_objectType" RENAME TO "QuickBooksImportReview_companyId_environment_realmId_object_key";

-- RenameIndex
ALTER INDEX "QuickBooksImportReview_companyId_objectType_confidence_status_i" RENAME TO "QuickBooksImportReview_companyId_objectType_confidence_stat_idx";

-- RenameIndex
ALTER INDEX "QuickBooksImportReview_company_object_blocker_idx" RENAME TO "QuickBooksImportReview_companyId_objectType_autoApprovalBlo_idx";

-- RenameIndex
ALTER INDEX "QuickBooksImportReview_exception_queue_idx" RENAME TO "QuickBooksImportReview_companyId_environment_realmId_object_idx";

-- RenameIndex
ALTER INDEX "QuickBooksMapping_companyId_environment_realmId_entityType_inte" RENAME TO "QuickBooksMapping_companyId_environment_realmId_entityType__key";

-- RenameIndex
ALTER INDEX "QuickBooksMapping_companyId_environment_realmId_entityType_quic" RENAME TO "QuickBooksMapping_companyId_environment_realmId_entityType__idx";

-- RenameIndex
ALTER INDEX "QuickBooksMergeReview_company_status_created_idx" RENAME TO "QuickBooksMergeReview_companyId_status_createdAt_idx";

-- RenameIndex
ALTER INDEX "QuickBooksMergeReview_pair_key" RENAME TO "QuickBooksMergeReview_companyId_environment_realmId_custome_key";

-- RenameIndex
ALTER INDEX "QuickBooksMergeReview_source_review_idx" RENAME TO "QuickBooksMergeReview_sourceReviewId_idx";

-- RenameIndex
ALTER INDEX "QuickBooksReviewDecision_actor_created_idx" RENAME TO "QuickBooksReviewDecision_actorId_createdAt_idx";

-- RenameIndex
ALTER INDEX "QuickBooksReviewDecision_review_created_idx" RENAME TO "QuickBooksReviewDecision_reviewId_createdAt_idx";

-- RenameIndex
ALTER INDEX "QuickBooksReviewDecision_scope_created_idx" RENAME TO "QuickBooksReviewDecision_companyId_environment_realmId_crea_idx";

-- RenameIndex
ALTER INDEX "QuickBooksSyncEvent_companyId_environment_realmId_entityType_in" RENAME TO "QuickBooksSyncEvent_companyId_environment_realmId_entityTyp_idx";

-- RenameIndex
ALTER INDEX "QuickBooksSyncRun_companyId_environment_realmId_type_createdAt_" RENAME TO "QuickBooksSyncRun_companyId_environment_realmId_type_create_idx";

-- RenameIndex
ALTER INDEX "SchedulingBooking_slot_unique" RENAME TO "SchedulingBooking_companyId_technicianUserId_windowId_local_key";

-- RenameIndex
ALTER INDEX "TechServiceElig_company_user_type_key" RENAME TO "TechnicianServiceEligibility_companyId_userId_serviceTypeId_key";

-- RenameIndex
ALTER INDEX "TechWindowAvail_company_user_window_weekday_key" RENAME TO "TechnicianWindowAvailability_companyId_userId_windowId_week_key";
